    ...
    render() {
        return (
            <View style={{ width: 120, height: 210, marginRight: 10 }}>
                <Image source={{ uri: this.props.image }} style={{ width: 110, height: 150 }} />
                <View style={{ flexDirection: 'column', marginTop: 5 }}>
                    <Text style={{ fontFamily: 'OpenSans-Bold', fontSize: 12, color: 'white' }}>{'Eps. ' + this.props.episode + ' Age ' + this.props.age}+</Text>
